...
var d3vUtil = {
	...
	*/
	...
	getOrgId : function() {
		...
		if(cookieVal) {
            var tempOid = cookieVal.substring(cookieVal.length - 15, cookieVal.length);
			return tempOid.indexOf('00D') != -1 ? tempOid : cookieVal.substring(cookieVal.length - 18, cookieVal.length);
		} else {
			return '';
		}
	},
